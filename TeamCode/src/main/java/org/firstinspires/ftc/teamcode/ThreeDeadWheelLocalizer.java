...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2476.4040435075044; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2440.788466491577; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1714.794026708882; // x position of the perpendicular encoder (in tick units)
    }
